...
operation::query-events[snippets='response-fields,curl-request,http-response,response-fields,links']
...
operation::create-event[snippets='request-fields,request-headers,curl-request,http-request,response-headers,response-fields,response-body,http-response,links']
